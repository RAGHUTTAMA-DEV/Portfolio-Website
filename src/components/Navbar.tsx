...
const GENERAL_INFO = {
  name: 'Raghu Kumar Rao',
  email: 'raghu.kumar.rao@example.com', // <-- Add your email here
};

const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    url: 'https://github.com/raghu-kumar-rao',
    icon: 'github',
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/raghu-kumar-rao/',
    icon: 'linkedin',
  },
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/raghu_kumar_rao/',
    icon: 'instagram',
  },
  {
    name: 'Twitter',
    url: 'https://twitter.com/raghu_kumar_rao',
    icon: 'twitter',
  },
];
